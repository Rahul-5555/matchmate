...
const Chat = ({
  ...
  const cleanupLocal = useCallback((reason = "unknown") => {
    ...
    // 🔥 DON'T resetCall here - let the component unmount handle it
    // Notify parent
